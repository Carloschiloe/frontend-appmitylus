...
function resolveBase() {
  ...
  if (typeof window !== 'undefined' && window.location) {
    ...
    // En prod FE, apuntar al backend por /api
...
// Exportamos la base para otros modulos (ej. modal.js)
...
export function create(payload) {
  return fx(API_INT, { method: 'POST', body: payload || {} });
}
