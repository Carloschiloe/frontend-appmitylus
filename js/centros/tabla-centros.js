...
export async function loadCentros(data) {
  ...
  try {
    ...
    const rows = (Estado.centros || []).map((c, i) => {
      ...
      const coordsCell = `
        <div class="acts">
          <button type="button" class="tbl-action-btn tbl-act-view btn-coords"
      ...
      const accionesCell = `
        <div class="acts">
          <button type="button" class="tbl-action-btn tbl-act-map btn-view-on-map"
                  data-idx="${i}" title="Ver en mapa" aria-label="Ver en mapa">
            <i class="bi bi-geo-alt"></i>
          </button>
          <button type="button" class="tbl-action-btn tbl-act-edit editar-centro"
                  data-idx="${i}" title="Editar centro" aria-label="Editar centro">
            <i class="bi bi-pencil"></i>
          </button>
          <button type="button" class="tbl-action-btn tbl-act-delete mu-red eliminar-centro"
