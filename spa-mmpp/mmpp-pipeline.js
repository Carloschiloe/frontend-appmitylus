...
function injectCSS(){
  ...
  +'.mmpp-main{min-height:100vh}'
  +'.mmpp-nav{position:sticky;top:18px;background:#fff;border:1px solid #e5e7eb;border-radius:20px;padding:16px;box-shadow:0 10px 30px rgba(17,24,39,.06)}'
  +'.mmpp-nav .brand{display:flex;align-items:center;gap:10px;margin-bottom:12px;font-weight:900;color:#1f2937}'
  +'.mmpp-nav .logo{width:32px;height:32px;border-radius:999px;background:#111827;color:#fff;display:grid;place-items:center;font-weight:900}'
  +'.mmpp-nav .section{margin:10px 0 6px;color:#64748b;font-size:12px;font-weight:800;text-transform:uppercase}'
  +'.mmpp-nav a{display:flex;gap:8px;align-items:center;padding:10px 12px;border-radius:12px;text-decoration:none;color:#334155;font-weight:700}'
  +'.mmpp-nav a .i{width:22px;text-align:center}'
  +'.mmpp-nav a:hover{background:#f1f5f9}'
  +'.mmpp-nav a.is-active{background:#eef2ff;border:1px solid #c7d2fe;color:#1e40af}'
  /* ====== PIPELINE UI ====== */
